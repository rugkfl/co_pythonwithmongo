...
collection_todos = todolist_functions.Connect_Mongo("todos_list")          # collection_todo -> collection_todos
...
todolist_functions.Data_insert(collection_todos, todo_list)         # collection_todo -> collection_todos
